...
public class GraphAdjList extends Graph {
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 List<Integer> neighborsOfV = adjListsMap.get(v);
		 //System.out.println("Neigbors of "+ v + " are: " + neighborsOfV.toString());
		 List<Integer> twoHopNeighborsOfV = new ArrayList<>();
		 for(Integer neighbor : neighborsOfV) {
		 	//System.out.println("Processing neighbor " + neighbor);
		 	for (Integer twoHopNeighbor : adjListsMap.get(neighbor)){
		 		twoHopNeighborsOfV.add(twoHopNeighbor);
			}
		 }
		 return twoHopNeighborsOfV;
	}
